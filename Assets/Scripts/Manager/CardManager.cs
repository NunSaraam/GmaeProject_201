...
public class CardManager : MonoBehaviour
{
    ...
    public void DrawCard()
    {
        ...
        Debug.Log("카드를 드로우 했습니다. : " + cardData.cardName + "(손패 :" + handCards.Count + "장");
    }
    ...
    public void ArrangeHand()
    {
        ...
        for (int i = 0; i < cardObjects.Count; i++)
        {
            ...
            Vector3 targetPositoin = handPosition.position + new Vector3(startX + (i * spacing), 0, 0);

            cardObjects[i].transform.position = Vector3.Lerp(cardObjects[i].transform.position, targetPositoin, Time.deltaTime * 10f);
        }
    }
